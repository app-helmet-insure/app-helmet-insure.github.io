    ...
    initMiningData() {
      ...
      let arr = [
        ...
        },
        {
          ...
          REARD_IMGSHOW: true,
          OPEN_TIME: this.getMiningTime("2021/08/02 00:00"),
          MING_TIME: this.getRemainTime("2021/08/16 00:00"),
          START_TIME: "2021/08/02 00:00 UTC+8",
          END_TIME: "2021/08/16 00:00 UTC+8",
          COMBO_FLAG: true,
          REWARD_TYPE: "APR",
          ONE_PAGER: "hMCRN",
          REWARD1_SYMBOL: "HELMET",
          ...
          MINING_DAY: 14,
          LEFTTOKEN: {
            ADDTOKEN_SYMBOL: "hMCRN",
            ADDTOKEN_ADDRESS: "0x4c60bd0a7aa839e35882c7a9b9b240ea7e0657bf",
            ADDTOKEN_DECIMALS: 18,
          },
          RIGHTTOKEN: {
            ADDTOKEN_SYMBOL: "MCRN",
            ADDTOKEN_ADDRESS: "0xacb2d47827c9813ae26de80965845d80935afd0b",
            ADDTOKEN_DECIMALS: 18,
          },
        ...
        },
        {
          ...
          MINING_DAY: 14,
          LEFTTOKEN: {
            ADDTOKEN_SYMBOL: "hWIZARD",
            ADDTOKEN_ADDRESS: "0x792b733af7b9b83331f90dbbd297e519258b09bc",
            ADDTOKEN_DECIMALS: 18,
          },
          RIGHTTOKEN: {
            ADDTOKEN_SYMBOL: "WIZARD",
            ADDTOKEN_ADDRESS: "0x5066c68cae3b9bdacd6a1a37c90f2d1723559d18",
            ADDTOKEN_DECIMALS: 18,
          },
        ...
        },
        {
          ...
          RIGHTTOKEN: {
            ADDTOKEN_SYMBOL: "MTRG",
            ADDTOKEN_ADDRESS: "0xBd2949F67DcdC549c6Ebe98696449Fa79D988A9F",
            ADDTOKEN_DECIMALS: 18,
          },
          PROXY_ADDRESS: "",
